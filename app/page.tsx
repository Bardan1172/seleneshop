      ...
      <main className="pt-16 min-h-screen text-white bg-black">
        ...
        >
          <div className="text-center max-w-2xl px-6">
            ...
            <p className="text-purple-100 mb-8 leading-relaxed italic">
        ...
        <section id="cara-order" className="bg-[#0b0b2e] px-6 py-24 border-y border-purple-500/10">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-black/40 border border-purple-500/20 p-8 rounded-3xl text-center">
                ...
                <p className="text-purple-100/70 text-sm">Pilih layanan dan siapkan referensi custom kamu.</p>
              </div>
              <div className="bg-black/40 border border-purple-500/20 p-8 rounded-3xl text-center">
                ...
                <p className="text-purple-100/70 text-sm">Lakukan pembayaran via E-Wallet dan konfirmasi bukti transfer.</p>
              </div>
              <div className="bg-black/40 border border-purple-500/20 p-8 rounded-3xl text-center">
                ...
                <p className="text-purple-100/70 text-sm">Hasil dikirim langsung via Discord sesuai antrean.</p>
              </div>
            </div>
          </div>
        </section>
