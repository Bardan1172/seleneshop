      ...
      <main className="relative">
        ...
        <section id="tentang" className="relative z-10 py-24 md:py-40 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className={`${fantasyFont} text-4xl md:text-7xl font-bold py-6 leading-tight`}>TENTANG KAMI</h2>
            <p className="text-white/40 leading-loose text-sm md:text-lg mb-12 uppercase tracking-widest italic font-light max-w-3xl mx-auto">
