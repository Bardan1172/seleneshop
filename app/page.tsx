  ...
  return (
    <div className="bg-[#05050a] min-h-screen text-white font-sans selection:bg-purple-500/30 overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className="absolute top-[-10%] left-[20%] w-[1px] h-[100px] bg-gradient-to-b from-transparent via-purple-400 to-transparent rotate-[45deg] animate-[shooting_8s_linear_infinite]" />
      </div>
      ...
      <section id="layanan" className="relative z-10 py-32 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {/* LEFT COLUMN: BUILDER SERVICES (INFORMASI ASLI) */}
            ...
            <div className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="p-8 rounded-[2rem] bg-black border border-white/5 hover:border-purple-500 transition-all group">
                   <h3 className="text-lg font-black mb-4 group-hover:text-purple-400 transition-colors uppercase">🧸 PNGTUBER</h3>
                ...
                <div className="p-8 rounded-[2rem] bg-black border border-white/5 hover:border-purple-500 transition-all group">
                   <h3 className="text-lg font-black mb-4 group-hover:text-purple-400 transition-colors uppercase">🎨 ART</h3>
                   <div className="space-y-4">
                ...
                <div className="p-8 rounded-[2rem] bg-black border border-white/5 hover:border-purple-500 transition-all group">
                   <h3 className="text-lg font-black mb-4 group-hover:text-purple-400 transition-colors uppercase">🎭 COSMETICA</h3>
                   <div className="space-y-4">
                ...
                <div className="p-8 rounded-[2rem] bg-black border border-white/5 hover:border-purple-500 transition-all group">
                   <h3 className="text-lg font-black mb-4 group-hover:text-purple-400 transition-colors uppercase">👕 MC SKIN</h3>
                   <div className="space-y-4">
              ...
              {/* CTA */}
              <a href="https://discord.gg/muH44HDrea" target="_blank" className="block w-full py-5 bg-white text-black text-center rounded-[1.5rem] font-black text-[11px] uppercase tracking-[0.3em] hover:bg-purple-600 hover:text-white transition-all shadow-2xl">
      ...
      {/* 4. WORKFLOW & STATS (RE-ADDED NUMBERS) */}
      <section className="relative z-10 py-24 px-6 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-4">
            <div className="p-8 bg-white/[0.03] border border-white/5 rounded-[2rem] relative overflow-hidden group">
              <span className="absolute -top-4 -right-2 text-7xl font-black text-white/[0.02] group-hover:text-purple-500/10 transition-colors">01</span>
              <h4 className="text-3xl font-black text-purple-400">100+</h4>
              <p className="text-[9px] text-white/40 uppercase font-black tracking-widest mt-2">Projects</p>
            </div>
            <div className="p-8 bg-white/[0.03] border border-white/5 rounded-[2rem] relative overflow-hidden group">
              <span className="absolute -top-4 -right-2 text-7xl font-black text-white/[0.02] group-hover:text-purple-500/10 transition-colors">02</span>
              <h4 className="text-3xl font-black text-purple-400">Premium</h4>
              <p className="text-[9px] text-white/40 uppercase font-black tracking-widest mt-2">Kualitas</p>
            </div>
            <div className="p-8 bg-white/[0.03] border border-white/5 rounded-[2rem] md:col-span-2 flex items-center justify-between relative overflow-hidden group">
                <span className="absolute -top-4 -right-2 text-7xl font-black text-white/[0.02] group-hover:text-purple-500/10 transition-colors">03</span>
                ...
                <div className="w-12 h-12 bg-white/10 rounded-full flex items-center justify-center group-hover:bg-purple-600 transition-colors">→</div>
            </div>
        </div>
      </section>

      {/* 5. PAYMENT */}
      <section className="relative z-10 py-24 px-6 text-center border-t border-white/5 bg-black/20">
      ...
      <footer className="relative z-10 py-12 text-center opacity-10 text-[8px] font-black tracking-[1.5em] uppercase">Selene Shop • Built for Excellence</footer>
